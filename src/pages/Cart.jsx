        ...
        <div class="lg:w-1/3 lg:ml-4 mt-4 lg:mt-0">
          <div class="p-4 bg-gray-50 border rounded" id="cart-summary">
            ...
            <div class="mt-4">
              <a href="#">
                <button
                  class="btn w-full bg-black text-white mb-2 rounded-2xl px-4 py-2 transition-all duration-500 ease-in-out hover:bg-gray-300 hover:text-black hover:font-bold hover:rounded-full"
                  id="guest-checkout"
                >
                  Guest Checkout
                </button>
              ...
              <a href="#">
                <button
                  class="btn flex items-center justify-center bg-white w-full mb-2 rounded-2xl px-4 py-2 transition-all duration-500 ease-in-out hover:bg-blue-100 hover:text-black hover:font-bold hover:rounded-full"
                  id="paypal-checkout"
                >
